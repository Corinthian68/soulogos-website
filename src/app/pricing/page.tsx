...
export default function PricingPage() {
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 pt-32 pb-6 overflow-hidden bg-[radial-gradient(ellipse_80%_70%_at_70%_30%,#111827_0%,#0A0D14_55%,#050709_100%)]"
      >
