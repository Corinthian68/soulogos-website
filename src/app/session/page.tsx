...
export default function SessionPage() {
  return (
    <>
      ...
      {/* ── THE PROBLEM ───────────────────────────────────────────────── */}
      <section id="problem" className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-10 w-full">
      ...
      {/* ── THE TWO OUTPUTS ───────────────────────────────────────────── */}
      <section id="outputs" className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-10 w-full">
        <div className="max-w-7xl w-full mr-auto">
          <GoldRule />
          <ScrollReveal className="mb-10">
      ...
      {/* ── PRIVACY ───────────────────────────────────────────────────── */}
      <section id="privacy" className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-10 bg-[linear-gradient(180deg,#0A0D14_0%,#0F1520_50%,#0A0D14_100%)]">
        <div className="max-w-7xl w-full mr-auto">
          <GoldRule />
          <ScrollReveal className="mb-10">
      ...
      {/* ── CROSS-SELL ────────────────────────────────────────────────── */}
      <section id="crosssell" className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-10 bg-[linear-gradient(180deg,#0A0D14_0%,#0F1520_50%,#0A0D14_100%)]">
        <div className="max-w-7xl w-full mr-auto">
          <GoldRule />
          <ScrollReveal className="mb-10">
      ...
      <section
        id="pricing"
        className="relative arcanum-section pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-10 w-full overflow-hidden bg-[radial-gradient(ellipse_70%_60%_at_30%_50%,rgba(201,168,76,0.06)_0%,rgba(15,21,32,0.8)_50%,#0A0D14_100%)]"
      >
        <div className="max-w-7xl w-full mr-auto">
          <GoldRule />
